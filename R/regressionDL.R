# MODIFIED TO NOT INCLUDE THE INTERACTIONS
...
regressionDL = function(y, X, nrun, burn = 0, thin = 1, delta_rw = 0.0526749,
  ...
  # Psi is fixed to be a zero matrix
  for(i in 1:nrun){
    ...
    if(dump & (i %% buffer == 0)){
      ...
      if(cf) out = c(out, list(phiSamps = PHI,
